...
<body>
	...
	<div id="container">
		...
		<form method="post" action="signup_form.php" onsubmit="validate()" enctype="multipart/form-data">
			<table cellpadding="4" cellspacing="4">
				...
				<tr>
					...
					<td><input type="text" name="location" placeholder="Enter your location...." maxlength="40" class="form-1" title="Enter your location" required /></td>
				</tr>
				...
				<tr>
					<td><input type="text" id="emailText" name="email" placeholder="Enter your email address....." class="form-1" title="Enter your firstname" required /></td>
				...
				<tr>
					<td><input type="password" id="pwdText" name="password" placeholder="Enter your password....." class="form-1" title="Enter your username" required /></td>

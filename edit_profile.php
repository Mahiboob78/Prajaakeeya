...
$location_save=$_POST['location'];
	...
	birthday ='$birthday_save' , gender ='$gender_save', number ='$number_save' ,location ='$location_save' WHERE user_id = '$id'")
				or die(mysql_error()); 
	echo "Saved!";
	...
	<div id="header">
		<div class="head-view">
			<ul>
				...
				<li><a href="edit_profile.php" title="Settings"><label class="active">Settings</label></a></li><li>|</li>
		...
		<fieldset class="---------------">
			...
			<table cellpadding="5" cellspacing="5">
				...
				<tr>
					...
					<td><input type="text" name="location" value="<?php echo $location; ?>" placeholder="Enter your location.." maxlength="40" class="form-1" title="Enter your location" required /></td>
				</tr>
			</table>
		</fieldset>
<br />		
